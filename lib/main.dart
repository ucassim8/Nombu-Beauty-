...
class _ServiceScreenState extends State<ServiceScreen> {
  ...
  void triggerWhatsApp() {
    ...
    // If time is between 6 PM (18) and 6 AM (6)
    ...
    FirebaseFirestore.instance.collection('bookings').add({
      ...
      'phoneNumber': phoneNumber,
      'location': '$selectedLocation, $selectedProvince',
      'price': finalPrice, // Saving the forced price
      'status': 'Pending',
      'timestamp': FieldValue.serverTimestamp(),
    });
  }
...
// ------------------------- ADMIN DASHBOARD -------------------------
// Add this helper for the payment request
...
// In your Admin ListView trailing Row:
IconButton(
